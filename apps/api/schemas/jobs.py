...
Владелец контракта — Backend (Разработчик 3). Потребители: фронтенд `apps/web/`
и offline smoke-тесты Разработчика 4. Любое изменение состава `JobState`
обязано сопровождаться уведомлением Разработчика 4: его smoke/demo-проверки
завязаны на этот словарь (матрица уведомлений, §5 координации).
"""
...
class JobState(StrEnum):
    """Стадии FSM джобы анализа (инвариант 8, `docs/BACKEND.md` §8.5).
