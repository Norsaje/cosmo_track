...
суммарное время зарегистрированного OOF/importance-этапа — 1 398 секунд. Полный
цикл, включая CPU-подготовку признаков, source cross-fit, importance, финальный
fit и batch inference, завершился за 43 минуты.
