...
Пути train/test передаются относительно корня проекта. out-md/out-json
пишутся в tests/smoke/_tmp/ (gitignored), тоже относительными путями.
Корневая директория проекта вычисляется
